...
{	    
    ...
    **/
	...
	{	
		$template = file_get_contents( dirname(dirname(__DIR__)) . '/resources/templates/awb-body.html' );
    ...
    **/
	...
	{	
		$template = file_get_contents( dirname(dirname(__DIR__)) . '/resources/templates/pod-body.html' );
    ...
    public function preparePdf($fileKey,$orders)
    {
        ...
        $dir = dirname(dirname(__DIR__)) . '/resources/tmp/';
    ...
    {
        //Add awb view styles
        $styles = file_get_contents( dirname(dirname(__DIR__)) . '/resources/templates/awb-style.html');
        $awbs =  $styles . $awbs . '</body></html>';

        //Add pod view styles
        $styles = file_get_contents( dirname(dirname(__DIR__)) . '/resources/templates/pod-style.html');
